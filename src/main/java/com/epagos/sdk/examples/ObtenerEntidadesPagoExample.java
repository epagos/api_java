...
public final class ObtenerEntidadesPagoExample {
    private static final ObjectMapper MAPPER = new ObjectMapper()
            .setSerializationInclusion(JsonInclude.Include.NON_NULL);

    private ObtenerEntidadesPagoExample() {
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Request obtenerEntidadesPago:");
        System.out.println(toJson(request));

        try {
            EpagosResult<ObtenerEntidadesPagoRequest, ObtenerEntidadesPagoResponse> result =
                    client.obtenerEntidadesPago(request);
